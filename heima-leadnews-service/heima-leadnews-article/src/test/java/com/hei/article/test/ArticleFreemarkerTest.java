...
public class ArticleFreemarkerTest {
    ...
    public void createStaticUrlTest() throws Exception {
        ...
        ApArticleContent apArticleContent = apArticleContentMapper
                .selectOne(Wrappers.<ApArticleContent>lambdaQuery().eq(ApArticleContent::getArticleId, 1302865306489733122L));
...
//        //4.修改ap_article表，保存static_url字段
//        ApArticle article = new ApArticle();
//        article.setId(apArticleContent.getId());
//        article.setStaticUrl(path);
//        int updateResult = apArticleMapper.updateById(article);
